  ...
  return (
    <main className='single_article'>
      ...
      <p id='article-body'>
        ...
        company in the Technology sector. During the press conference Bobby
        gleaned with excitement and energy as he made clear he is "more ready
        than ever to take on a new and exciting challenge". Famed for his
        ...
        <br />
        <br />
        When asked why he decided to sell his stake Bobby stated that he came to
        the realisation during the 2-years of interruption due to the Covid-19
        pandemic that he was "putting himself under a lot of pressure so early
        on in a relatively short career thus far, by juggling too many roles"
        and thus, wanted to focus his energy solely on a new challenge within
        the ever-evolving Tech industry. He also cited 'burnout' as a key factor
        in his decision-making.
        <br />
        <br />
        When pushed by reporters about who the company in question is, Bobby
        remained tight-lipped. However, he did reveal that the company he is set
        to work with is aligned with his ambitions and has "the perfect balance
        between innovation, culture and work-life balance where its employees
        can thrive". When asked about his long-terms ambitions, Bobby stated
        that he can see himself remaining in the country for the foreseeable
        future due to it's progressive outlook and world-renowned beauty,
        amongst other things. What's clear is that New Zealand will be getting a
        real asset in someone who has the potential to achieve big things there.
      </p>
      <br />
